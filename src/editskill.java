...
/**
 * Servlet implementation class editskill
 */
...
public class editskill extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String lName = JOptionPane.showInputDialog("Language Name");	
	    String rating = JOptionPane.showInputDialog("rating");
	    ...
	    try {
	        ...
	        rs = st.executeUpdate("UPDATE skill SET name='" + lName + "', rating='" +rating  +  "' where id=" + id + ";");
